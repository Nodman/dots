  ...
  -- lspconfig
  {
    ...
    config = function(_, opts)
      ...
      NeoUtils.lsp.on_attach(function(client, buffer)
        require("plugins.neovim.lsp.keymaps").on_attach(client, buffer)
      end)

      NeoUtils.lsp.setup()
      NeoUtils.lsp.on_dynamic_capability(require("plugins.neovim.lsp.keymaps").on_attach)
      ...
      if type(opts.diagnostics.virtual_text) == "table" and opts.diagnostics.virtual_text.prefix == "icons" then
        opts.diagnostics.virtual_text.prefix = vim.fn.has("nvim-0.10.0") == 0 and "▪"
          or function(diagnostic)
            local icons = NeoUtils.icons.diagnostics
      ...
      Snacks.toggle({
        ...
        get = function()
          -- NeoUtils.notification.inspect(vim.diagnostic.config())
      ...
      if have_mason then
        mlsp.setup({
          ...
          ensure_installed = vim.tbl_deep_extend(
            "force",
            ensure_installed,
            NeoUtils.plugin.opts("mason-lspconfig.nvim").ensure_installed or {}
          ),
          handlers = { setup },
        })
      end
